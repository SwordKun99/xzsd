package com.xzsd.pc.config;/*package com.config;*/
...
//        //具体分库分表策略
//        TableRule orderTableRule = TableRule.builder("t_sys_user")
//                .actualTables(Arrays.asList("t_sys_user_0", "t_sys_user_1"))
//                .tableShardingStrategy(new TableShardingStrategy("user_code", new TableShardingAlgorithm()))
...
//                .databaseShardingStrategy(new DatabaseShardingStrategy("role", new DatabaseShardingAlgorithm()))
//                .tableShardingStrategy(new TableShardingStrategy("user_code", new TableShardingAlgorithm()))
//                .build();
//    }
//
